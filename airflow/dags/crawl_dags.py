...
def match_incident(list_match_id):
    match_incident_data = []
    for match_id in list_match_id:
...
def match_lineups(list_match_id):
    match_lineups_data = []
    for match_id in list_match_id:
...
def match_manager(list_match_id):
    match_managers_data = []
...
def match_statistics(list_match_id):
...
def match_summary(list_match_id):
    match_summary_data = []
    for match_id in list_match_id:
...
def crawl_match_event():
    match_event()

def crawl_match_incident():
    match_incident()

def crawl_match_lineups():
    match_lineups()

def crawl_match_manager():
    match_manager()

def crawl_match_statistics():
    match_statistics()

def crawl_match_summary():
    match_summary()
...
(step_start >> crawl_data >> [crawl_shotmap, crawl_match_event, crawl_match_summary, crawl_match_lineups,
                              crawl_match_manager, crawl_match_incident, crawl_match_statistics, crawl_match_day] >>
 step_end)
